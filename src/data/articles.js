...
const articles = [
  ...
  {
    title: "L'impression 3D au service des mathématiques",
    resume: "Carlo Séquin explique les maths qui se cache dans le Ruban de Möbius et la Bouteille de Klein. Il utilise, pour sa demonstration, des formes imprimées en 3D qui permettent de mieux visualiser les concepts abordés.",
    date: '2015-06-24',
    category: 'science',
    button: watch,
    type: 'video',
